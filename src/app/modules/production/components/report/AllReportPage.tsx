          ...
          <div className='row col-12 mb-10'>
              ...
              >
                  ...
                  <h3><span className="bullet me-5"></span><Link to="/report/equipment-summary">Equipment
                      Summary</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/all-equip-summary">All Equipment
                      Summary</Link>
                  </h3>
              ...
              >
                  ...
                  <h3><span className="bullet me-5"></span><Link to="/report/equipment-transactions">Transactions</Link>
                  </h3>
              </div>
              <div
                style={{
              ...
              >
                  ...
                  <h3><span className="bullet me-5"></span><Link to="/report/fleet-history-report">Equipment
                      History</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/faultByModelSummary">Summary By
                      Model</Link>
                  </h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/FaultByCustodianSummary">Summary By
                      Custodian</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/sumBydownType">Summary By Down Type</Link>
                  </h3>
              ...
              >
                  ...
                  <h3><span className="bullet me-5"></span><Link to="/report/schedules/all-schedules">All
                      schedules</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/schedules/ScheduleByModelSummaryReport">Summary
                      By
                      Model</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/schedules/ScheduleByLocationReport">Summary
                      By
                      Location</Link></h3>
                  <h3><span className="bullet me-5"></span><Link to="/report/schedules/ScheduleByServiceTypeReport">Summary
                      By
              ...
              >
                  ...
                  <hr></hr>
                  {/*<h1>No Report</h1>*/}
                  <h3><span className="bullet me-5"></span><Link to="/report/changeout/ChangeOutByModel">Model</Link>
                  </h3>
              ...
              >
                  ...
                  <hr></hr>
                  {/*<h1>No Report</h1>*/}
                  <h3><span className="bullet me-5"></span><Link
                    to="/report/metering/MeteringByModelDetail">Model</Link></h3>
                  <h3><span className="bullet me-5"></span><Link
                    to="/report/metering/MeteringByModelSummary">Summary</Link>
                  </h3>
                  <h3><span className="bullet me-5"></span><Link
                    to="/report/metering/MeteringByEquipment">Equipment</Link>
                  </h3>
