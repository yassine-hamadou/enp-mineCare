...
const CategorySetup = () => {
  ...
  const {data: listOfCategory, isLoading: categoryLoading} = useQuery('category', getCategories)
  ...
  return (
    ...
    >
      <KTCardBody className='py-4 '>
        ...
        <Table
          columns={columns}
          dataSource={listOfCategory?.data}
          bordered
        ...
        >
          ...
          >
            <Form.Item label='Name' name='name' rules={[{required: true}]}>
              <Input placeholder='Enter Category Name' type='text' allowClear />
            </Form.Item>
          </Form>
        </Modal>
      </KTCardBody>
