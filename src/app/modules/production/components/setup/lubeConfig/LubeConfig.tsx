...
import {ENP_URL, fetchCompartments, fetchLubeBrands, getModels} from '../../../../../urls'
...
const LubeConfig = () => {
  ...
  const columns: any = [
    {
      ...
      render: (_: any, record: any) => {
        return record?.modelNavigation?.name
      },
    },
    {
      title: 'Compartment',
  ...
  const {data: allModel} = useQuery('models', () => getModels(tenant), {cacheTime: 5000})
          ...
          >
            ...
            >
              <Form.Item label='Model' name='model'>
                <Select showSearch placeholder='Search to select' optionFilterProp='children'>
