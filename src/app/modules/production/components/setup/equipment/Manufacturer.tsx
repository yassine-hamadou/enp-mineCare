...
const Manufacturer = () => {
    ...
    const {data: manufacturers, isLoading} = useQuery('manufacturersQuery', () => getManufacturers(tenant))
        ...
        },
        {
            ...
            render: (_: any, record: any) => (
              <Space size='middle'>
                  ...
                  <Popconfirm title={`Are you sure you want to delete ${record.name}?`} okText='Yes'
                              cancelText='No' onConfirm={() => handleDelete(record.manufacturerId)}>
    ...
    function handleDelete(element: any) {
        ...
        //the current record
        if (manufacturers?.data?.find((manufacturer: any) => manufacturer.manufacturerId === element)?.models?.length > 0) {
      ...
      <KTCard>
          <KTCardBody>
              ...
              <Table
                ...
                loading={isLoading}
              />
              <Modal title='Add Manufacturer' open={isModalOpen} onOk={handleOk} onCancel={handleCancel}
                     footer={[
