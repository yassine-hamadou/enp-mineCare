...
const usersColumns: ReadonlyArray<Column<User>> = [
  ...
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Down Type' className='border-end min-w-125px' />,
    accessor: 'position',
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Custodian' className='border-end min-w-125px' />,
    accessor: 'initials.label',
  },
  {
    Header: (props) => <UserCustomHeader tableProps={props} title='Location' className='border-end min-w-125px' />,
    accessor: 'joined_day',
  },
  {
    Header: (props) => (
