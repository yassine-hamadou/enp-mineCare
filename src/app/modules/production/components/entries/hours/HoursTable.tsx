...
import {addHours, getHours} from '../../../../../urls'
...
const HoursPage = () => {
  ...
  const allEquipForModelClassSelected = modelsForModelClassSelected.map(
    (model: any) => model.equipment
  ...
  const {data: allHours, isLoading} = useQuery('hours', () => getHours(tenant))
    ...
    <>
      ...
      >
        ...
        <Table
          bordered
          loading={isLoading}
          dataSource={allHours?.data?.filter((hour: any) => {
          ...
          >
            ...
            >
              {allEquipForModelClassSelectedFlat?.map((equip: any) => {
                return (
                  <Select.Option value={equip.equipmentId} key={equip.equipmentId}>
                    {equip.equipmentId}
                  </Select.Option>
                )
              })}
