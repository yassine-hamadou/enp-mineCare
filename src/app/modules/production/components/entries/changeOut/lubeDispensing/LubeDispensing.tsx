...
const LubeDispensing = () => {
  ...
  // const {data: lubeDispensingSources, isLoading: isLubeDispensingSourcesLoading} = useQuery(
  //   'lubeDispensingSources',
