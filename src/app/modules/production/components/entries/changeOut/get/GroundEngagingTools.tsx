        ...
        return (
          <Select
            ...
            onChange={(value) => {
              ...
              const equipment = hoursData?.data?.find(
                (equipment: any) => equipment?.fleetId === value
              )
              //@ts-ignore
              rowData[recordKey].previousHours = equipment?.previousReading
                ? equipment?.previousReading
                : 0 //set previous hours in this row
