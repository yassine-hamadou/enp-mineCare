                            ...
                            <>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Form.Item name='reasonForChange' label='Reason For Change'
                                                   rules={[{required: true}]}>
                                            <Input.TextArea
                                        ...
                                        <Form.Item name='lastChangeDate' label='Last Change Date'
                                                   rules={[{required: true}]}>
                                            <DatePicker
                                              showTime
                                              className='form-control form-control-solid'
                                        ...
                                        <Form.Item name='componentHours' label='Component Hours'
                                                   rules={[{required: true}]}>
                                            <InputNumber
                                              type='number'
                                              className='form-control form-control-solid'
                      ...
                      },
                      {
                          ...
                          children: (
                            <>
                                <div className='d-flex justify-content-between'>
                                    <Space style={{marginBottom: 16}}>
                                        <Button type={"primary"} onClick={() => setShowAgreementModal(true)}>Add
                                            Agreement</Button>
                                    </Space>
                                    <Modal
                                      title='Add Agreement'
