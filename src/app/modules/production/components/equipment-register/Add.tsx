...
import {ArrowRightOutlined, DetailsOutlined, DoneAllOutlined, InfoRounded} from "@mui/icons-material";
...
const AddEquipRegister = () => {
    ...
    const {mutate: addEquipment, isLoading: submitLoading} = useMutation((data) => postEquipment(data, tenant), {
        onSuccess: () => {
