      ...
      <>
          <Empty
            ...
            description={
                ...
                }><b>No sections found. Kindly setup sections for service type <span
                  style={{color: 'red'}}>{serviceType?.name}</span> under model <span
                  style={{color: 'red'}}>{serviceType?.model}</span> </b></span>
            }
          >
          </Empty>
      </>
