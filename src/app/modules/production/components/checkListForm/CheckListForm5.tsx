      ...
      <form id='kt_modal_add_plan_form' className='form' noValidate>
        {/* begin::Scroll */}
          ...
          <div className='d-flex justify-content-center'>
            <h2><strong>SECTION '5' - OPERATION/CAP</strong></h2>
            
          </div>
          <div className='d-flex justify-content-center mb-7'>
            <span className=" fs-5 text-danger font-weight-bold">Please read each lable carefully and select the appropriate option</span>
          </div>
          <Divider />
          {/* end::row */}
