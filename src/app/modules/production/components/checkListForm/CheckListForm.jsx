    ...
    <>
      ...
      >
        ...
        >
          ...
          {/*</span>*/}
          {/*</div>*/}
          {props.sections.groups.length > 0 ? (
            props.sections.groups.map((group, indexGroup) => {
              return (
                <>
                  <div>
                    <h2 className='mt-5'>
                        ...
                        <Empty
                          ...
                          description={
                            <span className='text-danger fw-bold fs-6'>
                              No items found for this group. Kindly setup new items for the group.
                            </span>
                          }
                        ></Empty>
                      </>
            ...
            <>
              <Empty
                ...
                description={
                  <span className='text-danger fw-bold fs-6'>
                    No groups found for this section. Kindly setup new groups for this section.
                  </span>
                }
              />
            </>
