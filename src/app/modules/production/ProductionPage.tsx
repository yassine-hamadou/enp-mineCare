...
import LubeDispensing from './components/entries/changeOut/lubeDispensing/LubeDispensing'
import LubeTypes from './components/setup/lubeType/LubeTypes'
import DispensingSource from './components/setup/lubeDispensing/DispensingSource'
import Reason from './components/setup/lubeDispensing/Reason'
import BacklogStatus from './components/setup/backlogs/BacklogStatus'
import WorkOrderType from './components/setup/work-order/WorkOrderType'
import WorkOrderCategory from './components/setup/work-order/WorkOrderCategory'
import WorkOrderPage from './components/entries/workOrder/WorkOrderPage'
import WorkOrderCreate from './components/entries/workOrder/WorkOrderCreate'
import WorkOrderUpdate from './components/entries/workOrder/WorkOrderUpdate'
import {PrintWorkOrderForm} from './components/entries/backlog/PrintWorkOrderForm'
import {PrintBacklogForm} from './components/entries/backlog/PrintBacklogForm'
...
const GroundEngagingTools = lazy(
  () => import('./components/entries/changeOut/get/GroundEngagingTools')
)
    ...
    <Routes>
      ...
      >
        ...
        >
          ...
          />
          <Route path='print' element={<ReportComponent reportName={'BacklogNewReport'} />} />
          <Route
            path=':fleetId'
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>{`View Backlog`}</PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ViewBacklog />
                  </ErrorBoundary>
        ...
        >
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>All Work Orders</PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <WorkOrderPage />
                  </ErrorBoundary>
          ...
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>Create Work Order</PageTitle>
                <WorkOrderCreate />
              </>
            }
          />
          <Route
            path='update/:workOrderId'
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>Update Work Order</PageTitle>
                <WorkOrderUpdate />
              </>
            }
          />
        ...
        >
          ...
          />
          <Route
            path='lube-dispensing'
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>Lube Dispensing</PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <LubeDispensing />
                  </ErrorBoundary>
      ...
      >
        ...
        <Route
          ...
          element={
            <>
              <PageTitle breadcrumbs={accountBreadCrumbs}>All Systems</PageTitle>
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <DownTypePage />
                </ErrorBoundary>
        ...
        <Route
          ...
          element={
            <>
              <PageTitle breadcrumbs={accountBreadCrumbs}>All Dispensing Sources</PageTitle>
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <DispensingSource />
                </ErrorBoundary>
        ...
        <Route
          ...
          element={
            <>
              <PageTitle breadcrumbs={accountBreadCrumbs}>All Dispensing Reasons</PageTitle>
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <Reason />
                </ErrorBoundary>
        ...
        <Route
          ...
          element={
            <>
              <PageTitle breadcrumbs={accountBreadCrumbs}>All Lube Types</PageTitle>
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <LubeTypes />
                </ErrorBoundary>
        ...
        >
          ...
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>All Backlog Statuses</PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <BacklogStatus />
                  </ErrorBoundary>
      ...
      >
              ...
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    ...
                    <ReportComponent reportName={'MeteringbyModelDetail'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'MeteringByEquipment'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'Meteringbymodelsummary'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
            ...
            element={
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    {/*<ChangeoutByModel/>*/}
                    <ReportComponent reportName={'ChangeoutByModel'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'AllChangeoutReport'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>
                  Changeout By Refill Type Model
                </PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'Changeoutbyrefilltypemodel'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
        ...
        >
              ...
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    ...
                    <ReportComponent reportName={'AllSchedulesReport'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>
                  Schedule By Model Summary Report{' '}
                </PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    {/*<ScheduleByModelSummaryReport/>*/}
                    <ReportComponent reportName={'ScheduleByModelSummaryReport'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>
                  Schedule By Model Service Type{' '}
                </PageTitle>
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'ScheduleByServiceTypeReport'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
          ...
          <Route
            ...
            element={
              <>
                ...
                <Suspense fallback={<TopBarProgress />}>
                  <ErrorBoundary>
                    <ReportComponent reportName={'ScheduleByLocationSummaryReport'} />
                  </ErrorBoundary>
                </Suspense>
              </>
            }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'EquipmentTransactionReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'FaultEntrySummaryReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'AllfaultsReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'AllBacklogsReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
            ...
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  ...
                  <ReportComponent reportName={'FaultByCustodianSummary'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'FaultByCustodianDetail'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'Daily_HME_KPIReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'AllEquipmentSummary'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'EquipmentDefect'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'FaultByDowntimeReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
            ...
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  ...
                  <ReportComponent reportName={'ListEquipmentSummary'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  {/*<FaultByModelSummary/>*/}
                  <ReportComponent reportName={'FaultByModelSummary'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  {/*<ServiceTypeReport/>*/}
                  <ReportComponent reportName={'ServiceTypeReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
            ...
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  ...
                  <ReportComponent reportName={'WarrantyEndOfLifeReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              <PageTitle breadcrumbs={accountBreadCrumbs}>
                Number Of Equipment Per Manufacturer{' '}
              </PageTitle>
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  {/*<HourlyReport/>*/}
                  <ReportComponent reportName={'HourlyReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'FaultEntrySolvedReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  {/*<FleetScheduleReport/>*/}
                  <ReportComponent reportName={'FleetScheduleReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
        ...
        <Route
          ...
          element={
            <>
              ...
              <Suspense fallback={<TopBarProgress />}>
                <ErrorBoundary>
                  <ReportComponent reportName={'FaultEntryFleetHistoryReport'} />
                </ErrorBoundary>
              </Suspense>
            </>
          }
      ...
      >
        ...
        >
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>Work Order Type</PageTitle>
                <WorkOrderType />
              </>
            }
          />
          <Route
            ...
            element={
              <>
                <PageTitle breadcrumbs={accountBreadCrumbs}>Work Order Category</PageTitle>
                <WorkOrderCategory />
              </>
            }
          />
